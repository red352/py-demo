...
'''
最后更新时间 2023/8/16 10:19 (total 14)
'''
class ParentplatformsSpider(scrapy.Spider):
    name = "parentPlatforms"
    allowed_domains = ["rawg.io"]
    start_urls = [
        "https://api.rawg.io/api/platforms/lists/parents?key=3b101a9b738740328e939f027359a02d&page=1&page_size=40"]
